...
const Project = () => {
  return (
    <div className="mt-10 ">
      <h1 className="uppercase font-bold mb-5 text-center text-3xl text-white hover:text-[#efff16]" id="project">
        Mes Projets
      </h1>
          ...
          >
            ...
            <div className=" flex flex-wrap gap-2 my-3">
                {projects.technologies.map((tech) => (
                    <span key={tech} className="badge bg-[#efff16] badge-sm text-black">
                        {tech}
                    </span>
                ))}
            </div>
            <div className=" flex gap-x-3 items-center">
                <a href={projects.demo} className="btn bg-[#efff16] text-black hover:scale-105 transition-all hover:bg-[#efff16] duration-300 w-2/3">
                    <FaPlay className="w-4 h-4"/>
                    Test
                </a>
                <a href={projects.gitHub} className="btn btn-neutral text-[#fff] hover:scale-105 transition-all duration-300 w-1/3">
